...
export const CUSTOMER_ORDERING_TEXT = {
  ...
  OFFER_ONE_BODY: 'Login to view eligible coupons and account offers before payment.',
  OFFER_TWO_TITLE: 'Restaurant offers',
  OFFER_TWO_BODY: 'Available offers are refreshed from your account at checkout.',
  PREVIOUS_ORDERS: 'Previous orders',
  PREVIOUS_ORDERS_BODY: 'Login to show your previous orders from this restaurant.',
  ITEM_COUNT: 'items',
  SUBTOTAL: 'Subtotal',
  TAX: 'Tax',
  PAYABLE: 'Payable',
