...
class ProductVariantModel {
  ...
  ProductVariantModel copyWith({String? name, num? price}) {
...
class ProductModel {
  ...
  final List<SubProductModel> supported_sub_products;
  ...
  const ProductModel({
    ...
    this.supported_sub_products = const [],
    this.branch,
    this.category,
    this.sub_category,
  });
  ...
  ProductModel copyWith({
    ...
    String? created_at,
    String? updated_at,
    List<SubProductModel>? supported_sub_products,
    BranchModel? branch,
    ...
    return ProductModel(
      ...
      supported_sub_products: supported_sub_products ?? this.supported_sub_products,
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    return ProductModel(
      ...
      supported_sub_products: json['supported_sub_products'] != null
          ? (json['supported_sub_products'] as List)
                .map((v) => SubProductModel.fromJson(v))
                .toList()
          : const [],
      ...
      sub_category: json['sub_category'] != null
          ? ProductSubCategoryModel.fromJson(json['sub_category'])
          : null,
    );
  }
