...
class CouponModel {
  ...
  factory CouponModel.fromJson(Map<String, dynamic> json) {
    return CouponModel(
      ...
      code: json['code'] ?? '',
      discount_pct: (json['discount_pct'] as num?)?.toDouble() ?? 0.0,
      min_order_val: (json['min_order_val'] as num?)?.toDouble() ?? 0.0,
      max_discount: (json['max_discount'] as num?)?.toDouble() ?? 0.0,
