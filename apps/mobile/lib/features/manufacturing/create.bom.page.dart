  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(ProductionConstant.createBomTitle, style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w900, color: AppColors.textPrimary)),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
          children: [
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    AppInput(hintText: ProductionConstant.outputProduct),
                    SizedBox(height: 16.h),
                    AppInput(hintText: ProductionConstant.expectedYield, keyboardType: TextInputType.number),
                    SizedBox(height: 16.h),
            ...
            Container(
              ...
              child: AppButton(
                text: ProductionConstant.saveRecipe,
