...
class ProductionBatchListPage extends StatefulWidget {
  ...
  @override
  State<ProductionBatchListPage> createState() =>
      _ProductionBatchListPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          ProductionConstant.BATCH_LIST_TITLE,
          style: TextStyle(
            fontSize: 16.sp,
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () =>
                      Navigator.pushNamed(context, '/production-batch-detail'),
                  child: Container(
                    padding: EdgeInsets.all(16.w),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8.h),
                        Text(
                          'BOM: ${batch.bom_id} (${batch.planned_qty} Planned)',
                          style: TextStyle(
                            fontSize: 13.sp,
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () =>
            Navigator.pushNamed(context, '/create-production-batch'),
        backgroundColor: AppColors.primaryGreen,
        icon: const Icon(Icons.add, color: AppColors.pureWhite),
        label: Text(
          ProductionConstant.NEW_BATCH,
          style: TextStyle(
