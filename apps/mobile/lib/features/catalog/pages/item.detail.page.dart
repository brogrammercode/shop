...
class _ItemDetailPageState extends State<ItemDetailPage> {
  ...
  void didChangeDependencies() {
    ...
    if (_item == null) {
      ...
      _category = state.itemCategories.where((c) => c.id == _item!.category_id).firstOrNull;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      if (_item!.images.isNotEmpty)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(image: NetworkImage(_item!.images.first), fit: BoxFit.cover),
                        ...
                        Container(
                          width: 100.w,
                          height: 100.w,
                          decoration: BoxDecoration(color: AppColors.primaryGreen.withOpacity(0.1), borderRadius: BorderRadius.circular(16.r)),
                          child: Center(child: Text(_item!.name.substring(0, 1).toUpperCase(), style: TextStyle(fontSize: 40.sp, fontWeight: FontWeight.w900, color: AppColors.primaryGreen))),
                        ),
                      SizedBox(width: 16.w),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(_item!.name, style: TextStyle(fontSize: 22.sp, fontWeight: FontWeight.w900, color: AppColors.textPrimary)),
                            SizedBox(height: 6.h),
                            Row(
                              children: [
                                Icon(Icons.category_outlined, size: 14.w, color: AppColors.textSecondary),
                                SizedBox(width: 4.w),
                                Text(_category?.name ?? 'Unknown', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w600, color: AppColors.textSecondary)),
                              ],
                            ),
                            ...
                            Wrap(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(_item!.item_type, style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w800, color: AppColors.primaryGreen)),
                                ),
                                if (_item!.shelf_life_days != null && _item!.shelf_life_days! > 0)
                                  Container(
                                    padding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 4.h),
                                    decoration: BoxDecoration(color: const Color(0xFFFEF3C7), borderRadius: BorderRadius.circular(6.r)),
                                    child: Text('Shelf Life: ${_item!.shelf_life_days} Days', style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w800, color: const Color(0xFF92400E))),
                                  ),
                              ],
                            ),
                          ],
                  ...
                  if (_item!.description != null && _item!.description!.isNotEmpty) ...[
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Description', style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w800, color: AppColors.textTertiary)),
                          SizedBox(height: 4.h),
                          Text(_item!.description!, style: TextStyle(fontSize: 14.sp, color: AppColors.textPrimary, height: 1.4)),
                        ],
                      ),
                    ),
                  ],
                  ...
                  SizedBox(height: 12.h),
                  if (state.loadVariantsInfo.status == OperationStatus.loading)
                    const Padding(
                    ...
                    Padding(
                      ...
                      child: Text('No variants added yet.', style: TextStyle(color: AppColors.textSecondary, fontSize: 13.sp)),
                    )
                  else
                    ...variants.map((v) => _buildVariantCard(context, v, state)),
                  SizedBox(height: 24.h),
                  AppButton(
                    ...
                    onPressed: () => Navigator.pushNamed(context, '/create-variant', arguments: _item),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildVariantCard(BuildContext context, ItemVariantModel variant, InventoryState state) {
