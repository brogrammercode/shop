  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ProcurementConstant.PO_DETAIL_TITLE,
          style: TextStyle(
            fontSize: 16.sp,
      ...
      floatingActionButton: AppBottomAction(
        child: Row(
          children: [
            Expanded(
              child: AppButton(
                text: ProcurementConstant.REJECT_PO,
            ...
            Expanded(
              child: AppButton(
                text: ProcurementConstant.APPROVE_PO,
                onPressed: () {},
              ),
            ),
          ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          ProcurementConstant.GRAND_TOTAL,
                          style: TextStyle(
                            fontSize: 16.sp,
