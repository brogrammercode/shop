  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(ProcurementConstant.supplierDetailTitle, style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w900, color: AppColors.textPrimary)),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 32.h),
            _buildSectionHeader(ProcurementConstant.recentPos),
            SizedBox(height: 12.h),
            Container(
              padding: EdgeInsets.all(16.w),
