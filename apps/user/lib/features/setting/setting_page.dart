...
import 'package:user/features/setting/setting.constant.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  Widget _buildProfileCard() {
    return BlocBuilder<AuthCubit, AuthState>(
      builder: (context, state) {
        ...
        final avatarUrl = user?.avatar_url != null && user!.avatar_url.isNotEmpty 
            ? user.avatar_url 
            : SettingConstant.DEFAULT_AVATAR_URL;
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 10.w),
                        Text(
                          SettingConstant.RENEW_MEMBERSHIP,
                          style: TextStyle(
  ...
  Widget _buildCategoryList() {
    return Column(
      children: SettingConstant.SETTING_CATEGORIES.map((category) {
        return Container(
                  ...
                  children: List.generate(category.items.length, (index) {
                    ...
                    return Column(
                      children: [
                        ...
                        if (category.title == SettingConstant.FEEDING_INDIA &&
                            item.label == SettingConstant.YOUR_IMPACT)
  ...
  Widget _buildSettingTile(SettingItem item, String categoryTitle) {
    ...
    } else if (item.label == SettingConstant.VEG_MODE) {
      trailingWidget = Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text(
            isVegModeOn ? SettingConstant.ON : SettingConstant.OFF,
            style: TextStyle(
              fontSize: 12.sp,
              color: AppColors.textSecondary,
    ...
    return ListTile(
      leading: Icon(
        item.icon,
        color: item.label == SettingConstant.VEG_MODE
      ...
      onTap: item.hasSwitch
          ? null
          : () {
              if (item.label == SettingConstant.VEG_MODE) {
                setState(() {
                  isVegModeOn = !isVegModeOn;
                });
              } else if (item.label == SettingConstant.LOG_OUT) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              SettingConstant.FEEDING_INDIA_BANNER_TEXT,
              style: TextStyle(
                fontSize: 11.sp,
                fontWeight: FontWeight.w700,
